 ...
 * @returns {CompressedResult | undefined}
 */
export function compress_base64(base64_input, quality, max_dimension) {
    const ptr0 = passStringToWasm0(base64_input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.compress_base64(ptr0, len0, quality, max_dimension);
    return ret === 0 ? undefined : CompressedResult.__wrap(ret);
}
...
export class CompressedResult {
    ...
    get base64() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.compressedresult_base64(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    get size_before() {
        const ret = wasm.compressedresult_size_before(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get size_after() {
        const ret = wasm.compressedresult_size_after(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
    ...
    get compression_ratio() {
        const ret = wasm.compressedresult_compression_ratio(this.__wbg_ptr);
        return ret;
    }
}
